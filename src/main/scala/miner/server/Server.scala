...
object Server {
  ...
  var bitcoinSet = 10000000 //10^7
  var workUnit = 10000  // 10^4
  var scalingFactor = 1
  ...
  def run() = {
    ...
    val numberOfServerWorkers = ((Runtime.getRuntime().availableProcessors()) * 3).toInt
    ...
    serverGuardian ! Messages.StartMining
  }
